...
const EVENTOS_MANUALES = [
    ...
    { time: '23:15', comp: 'Prueba HLS', home: 'Prueba HLS', away: 'Canal ESPN', channels: [{ name: 'Señal ESPN', url: 'https://x4bnd7lq.fubohd.com/espn/mono.m3u8?token=5f7b73cf0700191d57228ab2e9738aa87963a495-d3-1780563464-1780545464' }] }
];
...
function renderHlsPlayer(streamUrl, tempStreamUrl = null) {
    ...
    function loadPlayer(url) {
        ...
        // NOTA: Excluimos fubohd.com del proxy porque habilita CORS (*) de manera nativa pero bloquea las IPs de Cloudflare Workers (403)
        const proxiedUrl = url.includes('fubohd.com') 
            ? url 
            : (url.includes('token=') || url.includes('.m3u8')) 
